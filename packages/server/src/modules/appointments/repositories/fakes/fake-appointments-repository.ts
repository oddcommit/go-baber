...
import { IFindAllInMonthFromProviderDTO } from '@modules/appointments/dtos/interface-find-all-in-month-from-provider-dto';
import { IFindAllInDayFromProviderDTO } from '@modules/appointments/dtos/interface-find-all-in-day-from-provider-dto';
